...
/**
 * Creates the action for fill color.
 * 
 * @author Danielle Lambion
 * @version 19 May 2016
 */
public class FillColorChooserAction extends AbstractAction 
{
     ...
     */
    public FillColorChooserAction(final String theText, final CanvasPanel theCanvas) 
    {
        super(theText);
